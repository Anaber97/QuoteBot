...
export const DEFAULT_CLIENT_PORTAL = {
  ...
  weight_tiers: [
    { id: 'tier-1', label: '0–20,000 lbs', minWeight: 0, maxWeight: 20000, rate: 150, drive_time_buffer: 10, load_unload_base_mins: 30, rounding_interval: 25 },
    { id: 'tier-2', label: '20,001–40,000 lbs', minWeight: 20001, maxWeight: 40000, rate: 180, drive_time_buffer: 10, load_unload_base_mins: 30, rounding_interval: 25 },
    { id: 'tier-3', label: '40,001–60,000 lbs', minWeight: 40001, maxWeight: 60000, rate: 200, drive_time_buffer: 10, load_unload_base_mins: 30, rounding_interval: 25 },
    { id: 'tier-4', label: '60,001–80,000 lbs', minWeight: 60001, maxWeight: 80000, rate: 225, drive_time_buffer: 10, load_unload_base_mins: 30, rounding_interval: 25 },
    { id: 'tier-5', label: '80,001+ lbs', minWeight: 80001, maxWeight: 999999, rate: 250, drive_time_buffer: 10, load_unload_base_mins: 30, rounding_interval: 25 },
  ],
  clients: [],
};
...
export const normalizeClientPortalTier = (tier = {}, index = 0) => {
  return {
    ...
    rate: toFinite(tier.rate ?? tier.hourly_rate, 0),
