...
export default function ClientQuoteForm({ companyRates, onCalculate, isCalculating }) {
    ...
    <div className="bg-[#0c1019] border border-slate-800 rounded-2xl p-6 shadow-xl space-y-6">
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-white">Client Self-Service Quote Portal</h3>
