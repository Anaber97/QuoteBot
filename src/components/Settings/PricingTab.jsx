  ...
  return (
    <div className="flex flex-col gap-5 text-xs">
      ...
      <div className="order-2 bg-[#080c14] p-3.5 rounded-xl border border-slate-800 space-y-3">
        ...
        <div className="hidden gap-2 px-2 text-[10px] font-semibold uppercase tracking-wide text-slate-400 sm:grid sm:grid-cols-[1fr_1fr_0.8fr_0.9fr_0.9fr_auto]"><span>Min Weight (lbs.)</span><span>Max Weight (lbs.)</span><span>Rate ({rateUnit})</span><span>Drive Buffer (%)</span><span>Load / Unload (min.)</span><span>Delete</span></div>
